...
namespace System
{
	...
	class BoxConfig
	{
		...
		public:
			...
			unsigned N() { return d_N; } 		///< The number of pixels on each side
			unsigned bits() { return d_bits; } 	///< The number of bits = 2log(N)
			size_t size() { return d_size; }	///< The size of the box = N^rank
			double L() { return d_L; }		///< Length of the box in units of Mpc h^-1
			double scale() { return d_scale; }
			double scale2() { return d_scale2; }
